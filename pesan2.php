	...
	<form name="form1" method="post" action="pros.php">
		...
		<table border="1" >
			...
			<tr>
				<th>1</th>
				<th>BAJU/CELANA</th>
				<th><input type="text" name="baju" id="baju" size="7" value="10000/kg" readonly></th>
			...
			<tr>
				<th>2</th>
				<th>KEBAYA</th>
				<th><input type="text" name="kebaya" id="kebaya" size="7" value="14000/kg" readonly></th>
			...
			<tr>
				<th>3</th>
				<th>DRESS</th>
				<th><input type="text" name="dress" id="dress" size="7" value="45000/kg" readonly></th>
